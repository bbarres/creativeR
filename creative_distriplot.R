...
temp<-ventuMyc.dat[ventuMyc.dat$dose==30 & 
                     ventuMyc.dat$active_substance=="boscalid",]
...
plot(as.numeric(as.character(REZ_VeMyBosc$ED50)),
     col=REZ_VeMyBosc$X2,pch=19,cex=2, 
...
plot(as.numeric(as.character(REZ_VeMyDife$ED50)),
     col=REZ_VeMyDife$X2,pch=19,cex=2, 
...
plot(as.numeric(as.character(REZ_VeMyDodi$ED50)),
     col=REZ_VeMyDodi$X2,pch=19,cex=2, 
...
plot(as.numeric(as.character(REZ_VeMyTrif$ED50)),
     col=REZ_VeMyTrif$X2,pch=19,cex=2, 
...
temp<-ventuGer.dat[ventuGer.dat$dose==30 & 
                     ventuGer.dat$active_substance=="boscalid",]
temp<-cbind(as.character(temp$strain_ID),
            as.character(temp$species))[order(as.character(temp$strain_ID)),]
temp<-temp[-c(4,6),]
...
plot(as.numeric(as.character(REZ_VeGeBosc$ED50)),
     col=REZ_VeGeBosc$X2,pch=19,cex=2, 
...
plot(as.numeric(as.character(REZ_VeGeCapt$ED50)),
     col=REZ_VeGeCapt$X2,pch=19,cex=2, 
...
plot(as.numeric(as.character(REZ_VeGeCypr$ED50)),
     col=REZ_VeGeCypr$X2,pch=19,cex=2, 
...
plot(as.numeric(as.character(REZ_VeGeDith$ED50)),
     col=REZ_VeGeDith$X2,pch=19,cex=2, 
...
plot(as.numeric(as.character(REZ_VeGeDodi$ED50)),
     col=REZ_VeGeDodi$X2,pch=19,cex=2, 
...
plot(as.numeric(as.character(REZ_VeGeManc$ED50)),
     col=REZ_VeGeManc$X2,pch=19,cex=2, 
...
plot(as.numeric(as.character(REZ_VeGeMane$ED50)),
     col=REZ_VeGeMane$X2,pch=19,cex=2, 
